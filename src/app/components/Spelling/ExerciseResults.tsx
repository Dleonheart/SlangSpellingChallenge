    ...
    return (
        <div className={style.resultContainer}>
            ...
            { !this.props.isCorrect && (<div className={style.resultsComparison}>
                <p ref={this.addAnimTargetRef}><span className={style.rightsHeading}>Your anwer:</span>  <span>{this.props.answer}</span></p>
                <p ref={this.addAnimTargetRef}><span className={style.wrongsHeading}>Correct answer:</span>  <span>{this.props.result}</span></p>
